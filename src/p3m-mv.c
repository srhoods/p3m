...
static _Atomic bool     fixing;     /* in the finalize pass             */
static _Atomic uint64_t n_fixed;    /* finalize ops done so far         */
...
int main(int argc, char **argv)
{
    ...
    if (g.apply) {
        atomic_store(&n_fix_total, n_dfx + n_rml);
